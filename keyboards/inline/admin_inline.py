...
yes_clear_cat_kb = InlineKeyboardButton(
    text="❌ Да", callback_data="confirm_clear_category"
)
not_clear_cat_kb = InlineKeyboardButton(
    text="✅ Нет", callback_data="cancel_clear_category"
)
...
yes_clear_cat_kb = InlineKeyboardButton(
    text="❌ Да", callback_data="confirm_clear_position"
)
not_clear_cat_kb = InlineKeyboardButton(
    text="✅ Нет", callback_data="cancel_clear_position"
)
confirm_clear_position_inl.add(yes_clear_cat_kb, not_clear_cat_kb)

# Удаление товаров
confirm_clear_item_inl = InlineKeyboardMarkup()
yes_clear_item_kb = InlineKeyboardButton(
    text="❌ Да", callback_data="confirm_clear_item"
)
not_clear_item_kb = InlineKeyboardButton(
    text="✅ Нет", callback_data="cancel_clear_item"
)
